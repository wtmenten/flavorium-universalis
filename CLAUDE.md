...
- **Illustration tags**: valid values are `interior`, `exterior`, `military`, `army`, `economy`, `bank`, `burghers`, `discussing`, `fire`, `angry`, `armed`, `happy`, `professional`, `regular`, `ages`, `interior_peasant`. `combat` is NOT valid.
